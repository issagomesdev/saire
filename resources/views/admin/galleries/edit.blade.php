    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.galleries.update", [$gallery->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" type="text" name="description" id="description" value="{{ old('description', $gallery->description) }}">
            ...
            <div class="form-group">
                <label class="required" for="categories">{{ trans('cruds.gallery.fields.categories') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.gallery.fields.categories_helper') }}</span>
            </div>
            <div class="form-group">
